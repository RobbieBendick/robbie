    ...
    return (
        <div>
            <section className='home'>
                ...
                <div>
                    <motion.a href="#projects" whileFocus={{backgroundColor: "rgb(100, 255, 218, 0.1)"}} whileHover={{backgroundColor: "rgb(100, 255, 218, 0.1)"}} className='button-header fade-in-10'>Check out my work! <i class="fa-solid fa-arrow-down"></i></motion.a>
                </div>
            </section>
        </div>
    )
