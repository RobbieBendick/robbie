    ...
    return (
            <section id="projects" className="project-section">
                ...
                <ul className="projects-grid">
                    ...
                    <ProjectCard title="Google Keep Clone" description="A simple Google Keep clone built with React." tech1="React" tech2="CSS" tech3="HTML" githubSrc="https://github.com/RobbieBendick/note-keeper" externalSrc="https://robbiebendick.github.io/note-keeper/" />
                    <ProjectCard title="Memorizing Game" description="Web-clone of the game 'Simon'." tech1="JavaScript" tech2="JQuery" tech3="CSS" tech4="HTML" githubSrc="https://github.com/RobbieBendick/memorizing-game" externalSrc="https://robbiebendick.github.io/memorizing-game/"/>
                    ...
                    <ProjectCard title="Construction" description="Web app for a construction company to advertise their prices." tech1="JavaScript" tech2="Node" tech3="Express" tech4="EJS" githubSrc="https://github.com/RobbieBendick/brookeban" />
                    <ProjectCard title="Drum Kit" description="A web app where you can play the drums." tech1="JavaScript" tech2="HTML" tech3="CSS" githubSrc="https://github.com/RobbieBendick/drum-kit" externalSrc="https://robbiebendick.github.io/drum-kit/" />
                </ul>
            </section>
    );
  }
